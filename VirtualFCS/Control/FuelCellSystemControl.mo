...
block FuelCellSystemControl "Implement algorithms for the control of fuel cell systems."
...
equation
  ...
  Documentation(info = "<html><head></head><body>The FuelCellSystemControl manages all aspects related to the performance of the fuel cell stack and its related sub-systems. Most notably, the fuel cell control unit regulates the stack temperature by the flow of coolant and ensures sufficient flow of hydrogen and air to maintain the electrochemical reactions in the stack.</body></html>"));
