...
//*** DEFINE CONNECTIONS ***//
  ...
  connect(gain.u, speedSensor.w) annotation(
    Line(points = {{22, -24}, {22, 40}, {60, 40}, {60, 34}}, color = {0, 0, 127}));
