...
block PressureRegulator
  ...
  // Medium models
  replaceable package Medium = Modelica.Media.IdealGases.SingleGases.H2(Temperature(start = 293.15), AbsolutePressure(start = 101325)) constrainedby Modelica.Media.Interfaces.PartialSimpleIdealGasMedium;
  ...
  Modelica.Blocks.Nonlinear.FixedDelay fixedDelay(delayTime = 0.06) annotation(
  ...
  // Other
  Modelica.Fluid.Vessels.ClosedVolume volume(redeclare package Medium = Medium, V = 0.005, massDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, nPorts = 1, p_start = 101325*6, use_HeatTransfer = false, use_T_start = true, use_portsData = false) annotation(
