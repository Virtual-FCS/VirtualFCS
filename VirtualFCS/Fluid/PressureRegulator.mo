...
block PressureRegulator
  ...
  // Valves
  Modelica.Fluid.Valves.ValveCompressible valveCompressible(redeclare package Medium = Medium, checkValve = true, dp_nominal(displayUnit = "Pa") = 10000, m_flow_nominal = 0.01, p_nominal = 5 * 101325) annotation(
...
//*** DEFINE CONNECTIONS ***//
  ...
  connect(pid.y, valveCompressible.opening) annotation(
    Line(points = {{-21, -44}, {-35, -44}, {-35, -8}}, color = {0, 0, 127}));
protected
  annotation(
