...
model SubSystemHydrogen_TEST_FINAL
  //*** DEFINE REPLACEABLE PACKAGES ***//
  // Medium models
  inner Modelica.Fluid.System system annotation(
    Placement(visible = true, transformation(origin = {142, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Fluid.Vessels.ClosedVolume tankHydrogen(redeclare package Medium = Anode_Medium, T_start = system.T_start, V = 0.13, massDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, nPorts = 1, p_start = 35000000, use_HeatTransfer = true, use_portsData = false) annotation(
  ...
  Modelica.Fluid.Fittings.TeeJunctionIdeal teeJunctionIdeal1(redeclare package Medium = Anode_Medium) annotation(
    Placement(visible = true, transformation(origin = {188, -18}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  VirtualFCS.Electrochemical.Battery.BatterySystem batterySystem(V_max_bat_pack = 54, V_min_bat_pack = 40, V_nom_bat_pack = 48) annotation(
    Placement(visible = true, transformation(origin = {58, 52}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Blocks.Sources.Ramp setFuelCellCurrent(duration = 50, height = 50, startTime = 100) annotation(
    Placement(visible = true, transformation(origin = {-232, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Gain gain(k = -0.00202*1/(96485*2)) annotation(
    Placement(visible = true, transformation(origin = {-208, -42}, extent = {{-8, -8}, {8, 8}}, rotation = -90)));
equation
//*** DEFINE CONNECTIONS ***//
  ...
  connect(tankHydrogen.ports[1], pressureRegulatorHydrogenTank.Input) annotation(
    Line(points = {{-108, 74}, {-46, 74}}, color = {0, 127, 255}));
  ...
  connect(teeJunctionIdeal.port_1, pressureRegulatorHydrogenTank.Output) annotation(
    Line(points = {{16, 74}, {-14, 74}}, color = {0, 127, 255}));
  connect(teeJunctionIdeal.port_3, recirculationBlower.Output) annotation(
    Line(points = {{26, 64}, {26, 14}}, color = {0, 127, 255}));
  connect(sensorPressureTank.port, pressureRegulatorHydrogenTank.Input) annotation(
    Line(points = {{-68, 52}, {-46, 52}, {-46, 74}}));
  connect(sensorPressureHydrogenLine.port, pressureRegulatorHydrogenTank.Output) annotation(
    Line(points = {{2, 52}, {-14, 52}, {-14, 74}}, color = {0, 127, 255}));
  connect(teeJunctionIdeal2.port_3, sen_H2_mflow.port_a) annotation(
    Line(points = {{26, -66}, {26, -52}}, color = {0, 127, 255}));
  connect(sen_H2_mflow.port_b, recirculationBlower.Input) annotation(
    Line(points = {{26, -32}, {26, -18}}, color = {0, 127, 255}));
  ...
  connect(teeJunctionIdeal2.port_2, valveH2Purge.port_a) annotation(
    Line(points = {{16, -76}, {-30, -76}}, color = {0, 127, 255}));
  ...
  connect(valveH2Purge.port_b, exhaustHydrogen.ports[1]) annotation(
    Line(points = {{-50, -76}, {-110, -76}}, color = {0, 127, 255}));
  connect(teeJunctionIdeal.port_2, port_H2ToStack) annotation(
    Line(points = {{36, 74}, {78, 74}}, color = {0, 127, 255}));
  connect(teeJunctionIdeal2.port_1, port_StackToH2) annotation(
    Line(points = {{36, -76}, {78, -76}}, color = {0, 127, 255}));
  connect(setFuelCellCurrent.y, subSystemHydrogenControl.signalInterface_FC) annotation(
    Line(points = {{-220, 0}, {-120, 0}}, color = {0, 0, 127}));
  connect(setFuelCellCurrent.y, gain.u) annotation(
    Line(points = {{-220, 0}, {-208, 0}, {-208, -32}}, color = {0, 0, 127}));
  connect(gain.y, boundary.m_flow_in) annotation(
    Line(points = {{-208, -50}, {-198, -50}, {-198, -90}}, color = {0, 0, 127}));
  connect(teeJunctionIdeal1.port_2, port_StackToH2) annotation(
    Line(points = {{188, -28}, {188, -76}, {78, -76}}, color = {0, 127, 255}));
  connect(port_H2ToStack, teeJunctionIdeal1.port_1) annotation(
    Line(points = {{78, 74}, {188, 74}, {188, -8}}));
  connect(teeJunctionIdeal1.port_3, boundary.ports[1]) annotation(
    Line(points = {{198, -18}, {206, -18}, {206, -130}, {-190, -130}, {-190, -110}}, color = {0, 127, 255}));
  connect(batterySystem.pin_n, pin_n) annotation(
    Line(points = {{62, 42}, {62, 24}, {50, 24}, {50, -26}, {-14, -26}, {-14, -10}}, color = {0, 0, 255}));
  connect(batterySystem.pin_p, pin_p) annotation(
    Line(points = {{54, 42}, {54, 26}, {-16, 26}, {-16, 8}}, color = {0, 0, 255}));
  annotation(
...
end SubSystemHydrogen_TEST_FINAL;
