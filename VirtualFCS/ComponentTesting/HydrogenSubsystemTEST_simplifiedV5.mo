...
model HydrogenSubsystemTEST_simplifiedV5
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection convection annotation(
    Placement(visible = true, transformation(origin = {-74, 112}, extent = {{-8, 8}, {8, -8}}, rotation = 90)));
  Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyRadiation(Gr = 0.95 * 2) annotation(
    Placement(visible = true, transformation(origin = {-105, 111}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y = 12)  annotation(
    Placement(visible = true, transformation(origin = {-36, 112}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
...
equation
  ...
  connect(volume.heatPort, convection.solid) annotation(
    Line(points = {{-92, 94}, {-92, 100}, {-74, 100}, {-74, 104}}, color = {191, 0, 0}));
  connect(volume.heatPort, bodyRadiation.port_a) annotation(
    Line(points = {{-92, 94}, {-92, 100}, {-104, 100}, {-104, 104}}, color = {191, 0, 0}));
  connect(convection.fluid, fixedTemperature.port) annotation(
    Line(points = {{-74, 120}, {-74, 126}, {-132, 126}}, color = {191, 0, 0}));
  connect(bodyRadiation.port_b, fixedTemperature.port) annotation(
    Line(points = {{-105, 118}, {-107, 118}, {-107, 126}, {-132, 126}}, color = {191, 0, 0}));
  connect(realExpression.y, convection.Gc) annotation(
    Line(points = {{-47, 112}, {-67, 112}}, color = {0, 0, 127}));
  ...
  connect(realExpression1.y, pressureRegulator.setDownstreamPressure) annotation(
    Line(points = {{-57, 42}, {-30, 42}, {-30, 76}}, color = {0, 0, 127}));
  ...
  connect(volume.ports[1], pressureRegulator.Input) annotation(
    Line(points = {{-82, 84}, {-44, 84}}, color = {0, 127, 255}));
  annotation (experiment(StopTime = 600, Interval = 0.5, Tolerance = 1e-6));
end HydrogenSubsystemTEST_simplifiedV5;
