...
model SubSystemCoolingTEST_v4
  ...
  VirtualFCS.Thermal.PreHeater preHeater(L_pipe = 10)  annotation(
    Placement(visible = true, transformation(origin = {74, -32}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Fluid.Sensors.Temperature temperature2(redeclare package Medium = Medium) annotation(
    Placement(visible = true, transformation(origin = {54, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
