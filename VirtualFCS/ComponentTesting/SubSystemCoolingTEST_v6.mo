...
model SubSystemCoolingTEST_v6
  ...
  // Interfaces
  // Vessels
  Modelica.Fluid.Vessels.OpenTank tankCoolant(redeclare package Medium = Medium, crossArea = 0.0314, height = 0.16, level_start = 0.12, nPorts = 2, massDynamics = Modelica.Fluid.Types.Dynamics.FixedInitial, use_HeatTransfer = true, portsData = {Modelica.Fluid.Vessels.BaseClasses.VesselPortsData(diameter = 0.1), Modelica.Fluid.Vessels.BaseClasses.VesselPortsData(diameter = 0.1)}, T_start = Modelica.Units.Conversions.from_degC(20)) annotation(
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y = 400) annotation(
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConductor(G = 17770) annotation(
    Placement(visible = true, transformation(origin = {110, -58}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heatCapacitor(C = 1000) annotation(
