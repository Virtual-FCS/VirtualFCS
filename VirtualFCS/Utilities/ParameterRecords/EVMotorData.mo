...
record EVMotorData
  ...
  parameter Modelica.Units.SI.Voltage VaNominal = 343 "Nominal armature voltage" annotation(
  ...
  parameter Modelica.Units.SI.Current IaNominal = 100 "Nominal armature current (>0..Motor, <0..Generator)" annotation(
    Dialog(tab = "Nominal parameters"));
  parameter Modelica.Units.SI.AngularVelocity wNominal(displayUnit = "rev/min") = 8600 "Nominal speed" annotation(
    Dialog(tab = "Nominal parameters"));
