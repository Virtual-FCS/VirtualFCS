...
equation
  ...
  annotation(
    Diagram,
    Icon,
  Documentation(info = "<html><head></head><body>This example is intended as a means to evaluate the performance of the air subsystem both for optimization and troubleshooting purposes.<div><br></div><div><b style=\"font-size: 12px;\"><br></b></div><div><b style=\"font-size: 12px;\">Description</b></div><div><div style=\"font-size: 12px;\"><p class=\"MsoNormal\">The model has three parts input (includes fuel cell current and its conversion to air mass flow rate), air subsystem (includes hydrogen tank, pressure regulator, compressor, purge valve and control system), and power supply (battery system).&nbsp;</p><p class=\"MsoNormal\"><br></p><p class=\"MsoNormal\"><b>References to base model/related packages<o:p></o:p></b></p><p class=\"MsoNormal\"><span lang=\"NO-BOK\">&nbsp;</span><a href=\"modelica:///VirtualFCS.SubSystems.Hydrogen.SubSystemHydrogenControl\">Subsystem Hydrogen Control</a>,&nbsp;<a href=\"modelica:///VirtualFCS.Fluid.RecirculationBlower\">Recirculation Blower</a>,&nbsp;<a href=\"modelica:///VirtualFCS.Fluid.PressureRegulator\">Pressure Regulator</a>,&nbsp;<a href=\"modelica:///Modelica.Fluid.Valves.ValveCompressible\">Purge Valve</a>&nbsp;and&nbsp;<a href=\"modelica:///VirtualFCS.Electrochemical.Battery.BatterySystem\">Battery System</a></p></div>
