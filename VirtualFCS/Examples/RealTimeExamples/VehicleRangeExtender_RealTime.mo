...
model VehicleRangeExtender_RealTime "Example of a hybrid fuel cell & battery system as a range extended in an electric vehicle."
  ...
  Modelica_DeviceDrivers.Blocks.OperatingSystem.RealtimeSynchronize realtimeSynchronize(enable = true)  annotation(
...
equation
  ...
  annotation(
    ...
    experiment(StartTime = 0, StopTime = 300, Tolerance = 1e-06, Interval = 1));
end VehicleRangeExtender_RealTime;
