...
extends Modelica.Icons.Example;
  ...
  VirtualFCS.Powertrains.RangeExtenderPowerTrain rangeExtenderPowerTrain(SOC_init = 0.21, V_max_bat_pack = 360, V_min_bat_pack = 250, V_nom_bat_pack = 320)  annotation(
