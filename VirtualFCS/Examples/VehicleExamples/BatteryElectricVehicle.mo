...
model BatteryElectricVehicle
  ...
  VirtualFCS.Vehicles.VehicleProfile2 vehicleProfile2(VN = VirtualFCS.Vehicles.VehicleProfile2.vehicle_name.Mirai)  annotation(
...
equation
  connect(driveCycle.y, vehicleProfile2.vehicleVelocity) annotation(
    Line(points = {{-36, 0}, {-28, 0}, {-28, 0}, {-26, 0}}, color = {0, 0, 127}));
  connect(vehicleProfile2.pin_p, batteryPowerTrain.pin_p) annotation(
    Line(points = {{18, 10}, {44, 10}, {44, 10}, {42, 10}}, color = {0, 0, 255}));
  connect(vehicleProfile2.pin_n, batteryPowerTrain.pin_n) annotation(
