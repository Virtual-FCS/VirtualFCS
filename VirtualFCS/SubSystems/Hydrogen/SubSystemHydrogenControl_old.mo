...
model SubSystemHydrogenControl_old
  ...
  Modelica.Blocks.Sources.RealExpression getH2MassFlow(y = deMultiplexH2Sensors.y2[1]) annotation(
...
end SubSystemHydrogenControl_old;
