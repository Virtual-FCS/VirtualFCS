...
model SubSystemHydrogen_old
  //*** DEFINE REPLACEABLE PACKAGES ***//
  // Medium models
  replaceable package Anode_Medium = Modelica.Media.IdealGases.SingleGases.H2(Temperature(start = 293.15), AbsolutePressure(start = 101325));
