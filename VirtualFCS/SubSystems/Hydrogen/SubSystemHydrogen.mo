...
model SubSystemHydrogen
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_H2ToStack(redeclare package Medium = Anode_Medium) annotation(
    Placement(visible = true, transformation(origin = {115, 74}, extent = {{-9, -9}, {9, 9}}, rotation = 0), iconTransformation(origin = {-60, 118}, extent = {{-18, -18}, {18, 18}}, rotation = 0)));
  ...
  // Vessels
  Modelica.Fluid.Vessels.ClosedVolume tankHydrogen(redeclare package Medium = Anode_Medium, T_start = 293.15, V = V_tank_H2, nPorts = 1, p_start = p_tank_H2, use_HeatTransfer = true, use_portsData = false) annotation(
  ...
  inner Modelica.Fluid.System system(T_ambient(displayUnit = "K"))  annotation(
  ...
  VirtualFCS.SubSystems.Hydrogen.SubSystemHydrogenControl subSystemHydrogenControl(pressure_H2_set = 200000) annotation(
    Placement(visible = true, transformation(origin = {-98, -14}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
//*** DEFINE CONNECTIONS ***//
  ...
  connect(recirculationBlower.Output, teeJunctionIdeal.port_3) annotation(
    Line(points = {{26, 14}, {26, 64}}, color = {255, 0, 0}, thickness = 1));
  ...
  connect(control, subSystemHydrogenControl.signalInterface_FC) annotation(
    Line(points = {{-146, 0}, {-133, 0}, {-133, -2}, {-120, -2}}, color = {0, 0, 127}));
  connect(subSystemHydrogenControl.controlInterface, controlSignals.u) annotation(
    Line(points = {{-77, -14}, {-72, -14}, {-72, -12}, {-68, -12}}, color = {0, 0, 127}, thickness = 0.5));
  connect(sensors, subSystemHydrogenControl.signalInterface_H2) annotation(
    Line(points = {{146, 0}, {162, 0}, {162, -112}, {-160, -112}, {-160, -26}, {-120, -26}}, color = {0, 0, 127}, thickness = 0.5));
  ...
  connect(teeJunctionIdeal.port_2, port_H2ToStack) annotation(
    Line(points = {{36, 74}, {116, 74}, {116, 74}, {116, 74}}, color = {0, 127, 255}));
  annotation(
