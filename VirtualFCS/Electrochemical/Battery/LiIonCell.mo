...
<div><div><br></div><div>The equation for open-circuit voltage as a function of temperature and state of charge is taken from Vichard <i>et al.</i> [1], and is parameterized to the LFP chemistry by default.</div><div><div>
...
</div></div></div></div><div><b><u>Equations</u></b></div><div><u><i>Open-Circuit Voltage</i></u></div><div>OCV = <i>A<sub>1</sub></i> + <i>B<sub>1</sub>*</i>(20&nbsp;<span style=\"color: rgb(51, 51, 51); font-family: monospace; orphans: 2; text-align: center; widows: 2; background-color: rgb(255, 255, 255);\">°</span>C - <i>T &nbsp;</i><span style=\"color: rgb(51, 51, 51); font-family: monospace; orphans: 2; text-align: center; widows: 2; background-color: rgb(255, 255, 255);\">°</span>C)/<i>SOC</i> + <i>C<sub>1</sub></i>/sqrt(<i>SOC</i>) + <i>D<sub>1</sub></i>*<i>SOC</i> + <i>E<sub>1</sub></i>*ln(<i>SOC</i>) + <i>F<sub>1</sub></i>*ln(1.01 - <i>SOC</i>) + <i>G<sub>1</sub></i>*ln(1.001 - <i>SOC</i>) + <i>H<sub>1</sub></i>*exp(<i>I<sub>1</sub>*</i>(<i>T</i>&nbsp;<span style=\"color: rgb(51, 51, 51); font-family: monospace; orphans: 2; text-align: center; widows: 2; background-color: rgb(255, 255, 255);\">°</span>C))</div><div><pre style=\"margin-top: 0px; margin-bottom: 0px;\"><!--EndFragment--></pre></div><div><br></div><div>The coefficients for&nbsp;<i>A<sub>1</sub></i>-<i>I<sub>1</sub></i>&nbsp;are taken from [1] for LFP batteries.</div><div><br></div><div><b><u>References</u></b></div><div><!--StartFragment--><div class=\"csl-bib-body\" style=\"line-height: 2; \">
