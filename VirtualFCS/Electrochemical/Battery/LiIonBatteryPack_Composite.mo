...
protected
  annotation(
    ...
    version = "",
  Documentation(info = "<html><head></head><body><div>This model describes a lithium-ion battery pack as a composite of LiIonCell models. This setup has the advantage of being able to consider the performance of each individual cell, which may be useful for some investiations such as cell-balancing. However, it can also lead to a very large system of equations for complex models with many cells causing high computational cost.&nbsp;</div><div><br></div><div><b><u>Default Parameters</u></b></div><div>mass <span class=\"Apple-tab-span\" style=\"white-space:pre\">		</span>= 2.5&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">	</span>kg</div><div>Cp&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">		</span>= 1000&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">	</span>J/(kg.K)</div><div>SOC_init&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">	</span>= 0.5&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">	</span>-</div><div>p<span class=\"Apple-tab-span\" style=\"white-space:pre\">		</span>= 5<span class=\"Apple-tab-span\" style=\"white-space:pre\">		</span>Cells in parallel</div><div>s&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">		</span>= 10&nbsp;<span class=\"Apple-tab-span\" style=\"white-space:pre\">		</span>Cells in series</div><div><br></div></body></html>"));
